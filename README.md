...
| Ship | Name | Description | Version | Ore Crates | Mining Lasers
|---|---|---|---|---|---|
| <img src="bugger/photos/20220924104458_1.jpg" alt="Bugger" width="200" /> | [Bugger](bugger) | The Bugger is a 448 ore crate capacity mining ship with 10 sweeping mining lasers drill for surface mining operations. It is designed to work in conjunction with a moon base and a separate hauler as it is not the quickest ship. <br /><br />Premium version [Bugger X](bugger/premium/) available for purchase. | v1.0.1 | 448 | 10 |

## Asteroid Haulers

| Ship | Name | Description | Version | Asteroid Capacity | Loading Speed |
|---|---|---|---|---|---|
| <img src="rocker/photos/20211002134507_1.jpg" alt="Rocker" width="200" /> | [Rocker](rocker) | The Rocker is an asteroid hauling ship. It is designed to be used in the safe zone and haul small asteroids. It uses a tractor beam to position asteroids into five compartments of cargo lock beams in a circular pattern. It has load automation to approach and load asteroids in the right order as well as a material scanner that gives estimated credits for selling the asteroids.| v1.1.0 | 5 x T7 | Slow
...
| <img src="mapper/photos/20221022105027_1.jpg" alt="Mapper" width="200" /> | [Mapper](mapper) | The Mapper is an explorer ship with an estimated range of 13,000km capable at travelling at close to maximum speed. It has a navigation logger for logingg capital chip navigation chips. | v1.0.0 |
