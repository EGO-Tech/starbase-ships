...
| <img src="flipper/photos/20220721142859_1.jpg" alt="Flipper" width="200" /> | [Flipper](flipper) | The Flipper is a ship for hauling a single T10 asteroid, designed to be used in the safe zone. It flies in one direction to easily load the asteroid and then you can flip around and fly load in the opposite direction, still with decent speed. | v1.0.0 | 1 x T10  | Fast |
...
| <img src="hopper/photos/20220724173249_1.jpg" alt="Hopper" width="200" /> | [Hopper](hopper) | The Hopper is small personal transport that can be used to quickly get around a station or taking short trips. | v1.0.0 |
