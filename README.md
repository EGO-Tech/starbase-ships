...
| <img src="sower/photos/20220311205426_1.jpg" alt="Sower" width="200" /> | [Sower](sower) | The Sower is a starter ship designed to only require safe zone ore to build. It is quite fast and cheap, and with 36 crates, it makes a decent ship to use to help with the grind towards a more advanced ship. | v1.0.0 | No |
